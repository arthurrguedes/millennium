            ...
            <div className="accordion-content">
              <div className="rules-grid">
                <div className="rule-item">
                  ...
                  <p>Tracks originally released as part of an album in a prior period qualify for the current cycle if they are officially released as a single within the current eligibility window. Remastered releases are not elegible in this exception.</p>
                ...
                <div className="rule-item">
                  ...
                  <p><b>Linguistic Requirements:</b> For specific regional fields, such as the Latin Field, works must contain at least 51% lyrical content in the designated languages (Spanish or Portuguese) to remain eligible for those categories. For African Music categories are elegible songs of artists from the African continent.</p>
                ...
                <div className="rule-item">
                  ...
                  <p><b>Nominative Restrictions:</b></p>
                    <p>Artist-Only categories: Artist of the Year, Best New Artist, Producer of the Year, Songwriter of the Year, and Best Vocal Performance are restricted to lead acts.</p>
