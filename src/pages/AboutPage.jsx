            ...
            <div className="accordion-content">
              <div className="rules-grid">
                <div className="rule-item">
                  ...
                  <p><b>Eligibility Window:</b> Works must be released between October 1st and September 30th of the eligibility year to be considered for a nomination. Failure to submit a work within the designated timeframe renders it ineligible for nomination. No further entries will be accepted for that cycle, with the sole exception of works qualifying under the Five-Year Exception Rule, as detailed in the subsequent section.</p>
                ...
                <div className="rule-item">
                  ...
                  <p><b>Timeline & Nomination Phase:</b> The voting cycle commences 14 days after the eligibility window closes. During the first week, a shortlist of the top ten entries is established. In the second week, voters select five official nominees from this list; a sixth nominee is permitted only in the event of a tie.</p>
                ...
                <div className="rule-item">
                  ...
                  <p><b>Genre Classification:</b> The awards feature six specialized fields plus the General Field. Genre assignment is determined by a 51% content threshold; works failing to meet this requirement are categorized under "Alternative" or reallocated by voters based on cultural and sonic analysis. In unique cases, a work may qualify exclusively for the General Field. Latin category eligibility requires at least 51% lyrical content in Spanish or Portuguese, regardless of the artist's nationality. </p>
